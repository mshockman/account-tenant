...
import dev.shockman.messages.TenantCreatedEvent
import dev.shockman.messages.TenantDeletedEvent
import dev.shockman.messages.TenantUpdatedEvent
...
class TenantService(
    ...
    fun create(realm: Realm, createdTenant: CreateTenantRequest): Tenant {
        val tenant = tenantRepository.saveAndFlush(Tenant(
